        ...
        <Link href={href}>
            <div className="relative flex flex-col items-center justify-start gap-2 cursor-pointer active:scale-95 transition-transform group">
                <div className="relative w-14 h-14">
                    <div className="absolute inset-0 bg-[#0F172A]/40 rounded-full blur-md translate-y-1.5 scale-90"></div>
                    <div className="relative w-14 h-14 rounded-full bg-[#0F172A] bg-gradient-to-t from-white/40 via-white/5 to-transparent flex items-center justify-center group-hover:bg-slate-900 transition-all border border-white/20 overflow-hidden shadow-inner">
