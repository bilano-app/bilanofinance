        ...
        <MobileLayout>
            ...
            {!isGuestMode && (
                <div className="fixed bottom-[88px] right-4 flex flex-col gap-3 z-40 animate-in slide-in-from-bottom-10 fade-in">
                    ...
                    <Link href="/guide">
                        <button className="w-12 h-12 bg-brand-navy text-brand-gold rounded-full shadow-[3px_3px_0px_0px] shadow-slate-900 active:shadow-[1px_1px_0px_0px] active:shadow-slate-900 active:translate-x-[2px] active:translate-y-[2px] flex items-center justify-center transition-all group relative">
