  ...
  const guides = [
    {
      ...
      content: (
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
              ...
              <ImagePlaceholder label="Letak Gambar: Saldo Kas Utama" />
              ...
              <ImagePlaceholder label="Letak Gambar: Fitur Pilihan & Pintasan" />
    ...
    },
    {
      ...
      content: (
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
              ...
              <ImagePlaceholder label="Letak Gambar: Pemasukan Tunai" />
              ...
              <ImagePlaceholder label="Letak Gambar: Pemasukan Piutang" />
    ...
    },
    {
      ...
      content: (
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
              ...
              <ImagePlaceholder label="Letak Gambar: Pengeluaran Tunai & Peringatan Budget" />
              ...
              <ImagePlaceholder label="Letak Gambar: Pengeluaran Ngutang" />
    ...
    },
    {
      ...
      content: (
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
              ...
              <ImagePlaceholder label="Letak Gambar: Dasbor Valas & Live Rates" />
              ...
              <ImagePlaceholder label="Letak Gambar: Catat Mutasi Valas" />
              ...
              <ImagePlaceholder label="Letak Gambar: Tukar Valas (Jual/Beli)" />
    ...
    },
    {
      ...
      content: (
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
              ...
              <ImagePlaceholder label="Letak Gambar: Piutang (Uang Kita)" />
              ...
              <ImagePlaceholder label="Letak Gambar: Hutang (Pinjaman)" />
    ...
    },
    {
      ...
      content: (
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
              ...
              <ImagePlaceholder label="Letak Gambar: Estimasi Beban Tetap & Tambah Langganan" />
              ...
              <ImagePlaceholder label="Letak Gambar: Tagihan Berubah-ubah (Dinamis)" />
    ...
    },
    {
      ...
      content: (
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
              ...
              <ImagePlaceholder label="Letak Gambar: Dasbor Investasi" />
              ...
              <ImagePlaceholder label="Letak Gambar: Jual Aset & Profit/Loss" />
    ...
    },
    {
      ...
      content: (
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
              ...
              <ImagePlaceholder label="Letak Gambar: Download Laporan PDF" />
              ...
              <ImagePlaceholder label="Letak Gambar: Contoh Hasil Cetakan PDF & Grafik" />
    ...
    },
    {
      ...
      content: (
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
              ...
              <ImagePlaceholder label="Letak Gambar: Mode Suara (Voice Command)" />
              ...
              <ImagePlaceholder label="Letak Gambar: Mode Scan Struk" />
    ...
    },
    {
      ...
      content: (
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
              ...
              <ImagePlaceholder label="Letak Gambar: Progress Target Kekayaan" />
              ...
              <ImagePlaceholder label="Letak Gambar: Top Kategori & ROI Premium" />
