    ...
    <MobileLayout>
      <div className="flex flex-col -mx-5 -mt-5">
        ...
        <div className="px-5 pt-5 pb-8 bg-gradient-to-b from-[#FFFBEB] via-[#FEF3C7] to-[#FDE68A] flex flex-col relative z-10 border-b border-amber-300/60">
            ...
            {/* FLAGSHIP HERO CARD: CETAK LAPORAN BULAN INI (SATU-SATUNYA DENGAN SOLID SHADOW KHAS BILANO) */}
            <div className="bg-gradient-to-br from-[#1D3E72] via-[#16386D] to-[#0A162B] text-white p-6 rounded-[28px] border-l-[6px] border-l-brand-gold shadow-[6px_6px_0px_0px] shadow-slate-900 relative overflow-hidden mt-4">
                ...
                <div className="relative z-10 flex flex-col">
                    ...
                    <button 
                        ...
                        className="w-full h-14 bg-brand-gold hover:bg-[#e5a825] text-brand-navy font-bold text-xs uppercase tracking-wider rounded-2xl shadow-sm hover:shadow active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                    >
        ...
        <div className="px-5 pt-5 pb-28 bg-slate-50 flex flex-col gap-4">
            ...
            <div className="bg-white rounded-3xl p-5 border border-slate-200/80 shadow-xs hover:shadow-sm space-y-3">
                ...
                <div className="space-y-2">
                    {archiveList.map((arc, i) => (
                        ...
                        >
                            ...
                            <button 
                                ...
                                disabled={generatingId !== null} 
                                className={`px-4 py-2.5 rounded-xl font-bold text-[11px] uppercase tracking-wider flex items-center gap-1.5 shrink-0 shadow-xs active:scale-95 transition-all cursor-pointer ${
                    ...
                    {archiveList.length === 0 && (
                        <div className="text-center py-6 bg-slate-50 rounded-2xl border border-dashed border-slate-200 p-4">
                            ...
                            <p className="text-xs text-slate-500 font-medium">Belum ada arsip bulan lalu yang terkunci.</p>
                        </div>
                    )}
                </div>
            </div>
            ...
            <div className="space-y-2.5 pt-1">
                <h3 className="font-extrabold text-slate-800 text-xs uppercase tracking-wider flex items-center gap-1.5 px-1">
