...
import { 
    ...
    Globe, AlertTriangle, RefreshCw, Loader2, HandCoins, Wallet, AlertCircle
} from "lucide-react";
    ...
    if (!isDataLoaded) {
        return (
            <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center">
                <img src="/BILANO-LOGO-NEW.png" alt="Loading BILANO" className="w-24 h-24 mb-6 animate-pulse object-contain drop-shadow-lg" />
