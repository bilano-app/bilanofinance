...
import { LifeBuoy, Send, Loader2, CheckCircle2, MessageSquare, AlertCircle } from "lucide-react";
  ...
  return (
    <MobileLayout title="Pusat Bantuan" showBack={true}>
      <div className="p-1 pb-20 space-y-6 animate-in fade-in slide-in-from-bottom-4 mt-4">
          ...
          {isSuccess ? (
              <Card className="p-8 text-center rounded-[32px] shadow-lg border-2 border-emerald-100 animate-in zoom-in-95">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-1.5">
                      ...
                      <select 
                          ...
                          className="w-full h-14 px-4 bg-white border border-slate-200 rounded-[20px] font-bold text-slate-700 outline-none focus:border-rose-500 focus:ring-2 focus:ring-rose-200 transition-all appearance-none"
                      >
                  ...
                  <div className="space-y-1.5">
                      ...
                      <textarea 
                          ...
                          className="w-full min-h-[150px] p-4 bg-white border border-slate-200 rounded-[24px] text-sm outline-none focus:border-rose-500 focus:ring-2 focus:ring-rose-200 transition-all resize-none"
                      />
                  </div>

                  <div className="bg-rose-50 border border-rose-100 p-3 rounded-xl flex gap-3 items-start mt-2">
                  ...
                  <Button disabled={isSubmitting} className="w-full h-14 bg-rose-500 hover:bg-rose-600 text-white font-extrabold text-base shadow-lg shadow-rose-200 rounded-[20px] mt-4">
